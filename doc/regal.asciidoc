...
Einleitung
----------
to.science (ehemals "Regal") ist eine Content Repository zur Verwaltung und Veröffentlichung elektronischer Publikationen. Es wird seit 2013 am https://hbz-nrw.de[Hochschulbibliothekszentrum NRW (hbz)] entwickelt. 
...
- https://github.com/hbz/to.science.api[to.science.api]
- https://github.com/hbz/to.science.labels[to.science.labels]
- https://github.com/hbz/to.science.forms[to.science.forms]
...
- https://github.com/hbz/to.science.drupal[to.science.drupal]
