...
1. In **ZettelFields.Java** werden zunächst Verweise auf die Inhalte der labels.conf erzeugt. Dafür werden "Etikett"-Instanzen angelegt. 
...
4. Anschließend werden die in **ZettelField.Java** deklarierten Variablen importiert.
